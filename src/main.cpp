...
void drawTexture() {
        ...
        glBegin(GL_QUADS);
        glTexCoord2f(0.0f, 0.0f); glVertex2f(-W/100, -H/100);
        glTexCoord2f(0.0f, 1.0f); glVertex2f(-W/100,  H/100);
        glTexCoord2f(1.0f, 1.0f); glVertex2f(W/100,  H/100);
        glTexCoord2f(1.0f, 0.0f); glVertex2f(W/100, -H/100);
        glEnd();
